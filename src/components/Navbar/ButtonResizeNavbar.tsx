...
type Props = {
  actionResizeNavbar(): void;
};

const ButtonResizeNavbar = (props: Props) => {
  return (
    <button
      className="bg-base md:hidden h-10 w-10 rounded-lg flex-center"
      onClick={props.actionResizeNavbar}
    >
      <svg
        width="24"
        height="24"
...
export default ButtonResizeNavbar;
